...
namespace DataBaseExample {
    ...
    public partial class UniversityDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow AddStudentRow(int StudentId, string FirstName, string LastName, string Major, decimal GPA) {
...
namespace DataBaseExample.UniversityDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_GPA", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 18, 0, "GPA", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([StudentId], [FirstName], [LastName], [Major], [GPA]" +
                ") VALUES (@StudentId, @FirstName, @LastName, @Major, @GPA);\r\nSELECT StudentId, F" +
                "irstName, LastName, Major, GPA FROM Student WHERE (StudentId = @StudentId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [StudentId] = @StudentId, [FirstName] = @FirstName, [LastName] = @LastName, [Major] = @Major, [GPA] = @GPA WHERE (([StudentId] = @Original_StudentId) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Major = 1 AND [Major] IS NULL) OR ([Major] = @Original_Major)) AND ((@IsNull_GPA = 1 AND [GPA] IS NULL) OR ([GPA] = @Original_GPA)));
SELECT StudentId, FirstName, LastName, Major, GPA FROM Student WHERE (StudentId = @StudentId)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@GPA", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 18, 0, "GPA", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_GPA", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 18, 0, "GPA", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentId, FirstName, LastName, Major, GPA FROM dbo.Student";
        ...
        public virtual int Delete(int Original_StudentId, string Original_FirstName, string Original_LastName, string Original_Major, global::System.Nullable<decimal> Original_GPA) {
            ...
            if ((Original_GPA.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((decimal)(Original_GPA.Value));
            }
            else {
        ...
        public virtual int Insert(int StudentId, string FirstName, string LastName, string Major, global::System.Nullable<decimal> GPA) {
        ...
        public virtual int Update(int StudentId, string FirstName, string LastName, string Major, global::System.Nullable<decimal> GPA, int Original_StudentId, string Original_FirstName, string Original_LastName, string Original_Major, global::System.Nullable<decimal> Original_GPA) {
            ...
            if ((GPA.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[4].Value = ((decimal)(GPA.Value));
            }
            else {
            ...
            if ((Original_GPA.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((decimal)(Original_GPA.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Major, global::System.Nullable<decimal> GPA, int Original_StudentId, string Original_FirstName, string Original_LastName, string Original_Major, global::System.Nullable<decimal> Original_GPA) {
